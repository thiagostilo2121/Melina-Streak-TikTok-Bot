...
user_windows = db.readChase("Melina Streak Bot/src", "wuser")
cname = db.readChase("Melina Streak Bot/src", "cname")
...
def enviar_mensaje():
    ...
    try:
        ...
        mensaje = "↪ Este es un mensaje automático para mantener la racha ↩"
...
schedule.every().day.at(db.readChase("Melina Streak Bot/src", "hour")).do(enviar_mensaje)
